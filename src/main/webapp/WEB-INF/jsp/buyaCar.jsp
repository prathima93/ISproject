...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#">Buy Car</a>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="/checkOut"><img class="card-img-top" src="/images/BMW.jpg"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="/checkOut"><img class="card-img-top"
								src="/images/Ferrari.jpg" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="/checkOut"><img class="card-img-top"
								src="/images/Honda Accord.jpg" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="/checkOut"><img class="card-img-top"
								src="/images/Hyundai Sonata.jpg" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="/checkOut"><img class="card-img-top"
								src="/images/Lamborghini.jpg" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
